...
from .transformer import  IntentPred, TransformerModel_no_softmax_v5
...
def create_model_int(ip_dim, seq_len,d_model,nhead,nlayers,dropout):
    return IntentPred(ip_dim=ip_dim,seq_len=seq_len, d_model=d_model, nhead=4, d_hid=d_model, nlayers=2, dropout=dropout)
